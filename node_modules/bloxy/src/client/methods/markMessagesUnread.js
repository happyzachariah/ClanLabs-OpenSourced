...
exports.run = async function (messageIds) {
	...
	let response = await this._setup.request.request("https://www.roblox.com/messages/api/mark-messages-unread", options);
...
exports.conf = {
	...
	name: "markMessagesUnread",
	description: "Marks the messages as unread",
